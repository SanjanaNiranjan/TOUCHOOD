...
//        settingsButton.setOnClickListener(this::launchSettingsMenuDialog);
    ...
    //region Android full screen mode
    @Override
...
//    }
        ...
        Toast.makeText(getApplicationContext(), "Img saved", Toast.LENGTH_SHORT).show();
    }
...
//endregion
    ...
    public void deleteMethod(View v) {
        ...
        Toast.makeText(getApplicationContext(), " Model deleted", Toast.LENGTH_SHORT).show();
    }
    //endregion
    ...
    //region=======plane rendering method=======
    public void plane_check_Method(View v) {
        if(plane_check==0){
            Toast.makeText(getApplicationContext(), "Plane Renderer Removed", Toast.LENGTH_SHORT).show();
            plane_check=1;
        }else if(plane_check==1){
            Toast.makeText(getApplicationContext(), "Plane Renderer Created", Toast.LENGTH_SHORT).show();
            plane_check=0;
        }
